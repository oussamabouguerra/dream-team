...
include "produitC.php";
				...
				$list=$produitC->trierpromotiondesc();
				?>
...
<li class="slide">
							<a class="side-menu__item"  data-toggle="slide" href="afficherproduit.php"><i class="side-menu__icon fa fa-laptop"></i><span class="side-menu__label"> Articles</span></a>
...
<td>
	<a href="trierpromotion.php?id=<?PHP echo $row['referance']; ?>"><button type="submit" class="btn btn-primary mt-1 mb-0" >Trie Asc</button></a>
</td>
