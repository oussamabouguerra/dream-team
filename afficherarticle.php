...
$list=$articleC1->afficherarticle();
...
<td>
	<a href="modifierarticle.php?id=<?PHP echo $row['id']; ?>"><button type="submit" class="btn btn-primary mt-1 mb-0" >Ajouter en  promotion</button></a>
</td> 
