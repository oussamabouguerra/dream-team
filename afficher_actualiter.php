...
<head>
		...
		<title>Afficher Actualités</title>
...
<ul class="slide-menu">
        ...
        <!--aside closed-->
                        ...
                        <!--page-header open-->
						<div class="page-header">
							<h4 class="page-title">Afficher Actualités</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#" class="text-light-color">Fournisseur</a></li>
								<li class="breadcrumb-item active" aria-current="page">Afficher Actualités</li>
							</ol>
						</div>
						<!--page-header closed-->
...
<!-- Mirrored from www.spruko.com/demo/splite/formelements.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:34:42 GMT -->
			...
			<?php } }
        		...
        		echo "<META http-equiv='refresh' content='0;URL=afficher_actualite.html'>";}
    		<?php }
