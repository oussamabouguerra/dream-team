...
<a href="gestion_client.html"  class="side-menu__item" ><i class="side-menu__icon fa fa-laptop"></i><span class="side-menu__label">Gestion Clients</span></a>
<ul class="slide-menu">
...
<ul class="slide-menu">
        ...
        <!--aside closed-->
                        ...
                        <!--page-header open-->
						<div class="page-header">
							<h4 class="page-title">Afficher Clients</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#" class="text-light-color">Fournisseur</a></li>
								<li class="breadcrumb-item active" aria-current="page">Afficher Clients</li>
							</ol>
						</div>
						<!--page-header closed-->
...
<!-- Mirrored from www.spruko.com/demo/splite/formelements.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:34:42 GMT -->
			...
			<?php } }
        		...
        		echo "<META http-equiv='refresh' content='0;URL=fournisseur_afficher_client.html'>";}
    		<?php }
