...
include "../core/promotionC.php";
				...
				$list=$promotionC->trierpromotiondesc();
				?>
            ...
            <!--nav closed-->
                ...
                <div class="app-sidebar__user">
                    <div class="dropdown user-pro-body text-center">
                        ...
                        <div class="user-info">
                            <h6 class=" mb-1 text-dark">Admin Promotion</h6>
                        </div>
                    </div>
                </div>
...
<li class="slide">
							<a class="side-menu__item"  data-toggle="slide" href="afficherpromotion.php"><i class="side-menu__icon fa fa-laptop"></i><span class="side-menu__label"> Promotion</span></a>
...
<a href="accueil.html"  class="side-menu__item" ><i class="side-menu__icon fa fa-laptop"></i><span class="side-menu__label">Quitter</span></a>
				...
				<div class="app-content">
					<section class="section">
                        ...
                        <!--page-header open-->
						<div class="page-header">
							<h4 class="page-title">Trie Desc</h4>
							<ol class="breadcrumb">
...
<td>
	<a href="trierpromotion.php?id=<?PHP echo $row['id']; ?>"><button type="submit" class="btn btn-primary mt-1 mb-0" >Trie Asc</button></a>
</td>
