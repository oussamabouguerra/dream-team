...
<head>
		...
		<title>Afficher mon compte</title>
...
<a href="envoyer_mail_client.html"  class="side-menu__item" ><i class="side-menu__icon fa fa-laptop"></i><span class="side-menu__label">Envoyer E-mail</span></a>
<ul class="slide-menu">
...
<ul class="slide-menu">
        ...
        <!--aside closed-->
                        ...
                        <!--page-header open-->
						<div class="page-header">
							<h4 class="page-title">Afficher mon compte</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#" class="text-light-color">Client</a></li>
								<li class="breadcrumb-item active" aria-current="page">Afficher Client</li>
							</ol>
						</div>
						<!--page-header closed-->
                        ...
                        <!--row open-->
							...
							<div class="col-lg-12 col-xl-6 col-md-12 col-sm-12">
								<div class="card">
									...
									<div class="card-body">
										<form class="form-horizontal" method="POST" action="afficher_client.php"  name="f">
...
<!-- Mirrored from www.spruko.com/demo/splite/formelements.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:34:42 GMT -->
			...
			<?php } }
        		...
        		echo "<META http-equiv='refresh' content='0;URL=afficher_client.html'>";}
    		<?php }
